...
class drawArm:
    ...
    def checkAngle(self):
        ...
        #'''
        counter = 0
        while self.findSlope(self.elbow[0], self.elbow[1], self.wrist[0], self.wrist[1]) < self.findSlope(self.shoulder[0], self.shoulder[1], self.elbow[0], self.elbow[1]) and self.elbow[1] >= 0 and self.elbow[0] >= 0:
